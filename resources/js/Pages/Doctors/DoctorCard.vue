  ...
  >
    ...
    <div class="flex items-center gap-4 mb-6 relative z-10">
      <div class="relative flex-shrink-0">
        <div
          class="h-14 w-14 rounded-xl bg-slate-100 flex items-center justify-center text-slate-600 font-bold text-lg border border-slate-200 group-hover:bg-indigo-600 group-hover:text-white group-hover:border-indigo-600 group-hover:rotate-3 transition-all duration-300"
        >
      ...
      <div class="flex-1 min-w-0">
        <div class="flex items-center gap-2">
          ...
          <span
            class="px-2 py-0.5 rounded-md bg-slate-100 group-hover:bg-indigo-100 group-hover:text-indigo-600 text-[10px] font-bold text-slate-500 uppercase tracking-tight transition-colors"
          >
            Staff
          </span>
        </div>
