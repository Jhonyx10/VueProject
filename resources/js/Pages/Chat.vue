                    ...
                    <div class="w-full md:w-80 lg:w-96 border-r border-slate-100 flex flex-col bg-slate-50/50">
                        ...
                        <div class="flex-1 overflow-y-auto">
                            <div v-for="chat in chats" :key="chat.id"
                                :class="['flex items-center px-4 py-4 cursor-pointer transition-all hover:bg-white border-l-4',
                                    chat.active ? 'bg-white border-indigo-500 shadow-sm' : 'border-transparent text-slate-500']">
